codeunit 58001 "Dummy Batch Upload"
{
    trigger OnRun()
    begin
    ...
    begin
        ...
        // FileList := GetFilesFromFolder(ServerFolder); -> This doesn't work in runtime 6
        GetFilesFromFolder(ServerFolder, FileArray); // This works in runtime 6

        // Loop through each file
        // foreach FileName in FileList do begin -> This doesn't work in runtime 6
        for i := 1 to ArrayLen(FileArray) - 1 do begin
    ...
    procedure GetFilesFromFolder(ServerFolder: Text; var FileArray: array[1000] of Text)
    var
    ...
    begin
        ...
        if NameValueBuffer.FindSet() then begin
            repeat
                if ArrayIndex < ArrayLen(FileArray) then begin
                    FileArray[ArrayIndex] := NameValueBuffer.Name;
                    ArrayIndex += 1;
                end;
